...
return (new CustomEvent(event_name,(function (){var obj39776 = ({"detail":data});
return obj39776;
})()));
} else {
...
var f = (function (){var pred__39783 = cljs.core._EQ_;
var expr__39784 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__39783.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__39784))){
return ((function (pred__39783,expr__39784){
return (function (p1__39777_SHARP_){
return console.warn(p1__39777_SHARP_);
});
;})(pred__39783,expr__39784))
} else {
if(cljs.core.truth_(pred__39783.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__39784))){
return ((function (pred__39783,expr__39784){
return (function (p1__39778_SHARP_){
return console.debug(p1__39778_SHARP_);
});
;})(pred__39783,expr__39784))
} else {
if(cljs.core.truth_(pred__39783.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__39784))){
return ((function (pred__39783,expr__39784){
return (function (p1__39779_SHARP_){
return console.error(p1__39779_SHARP_);
});
;})(pred__39783,expr__39784))
} else {
return ((function (pred__39783,expr__39784){
return (function (p1__39780_SHARP_){
return console.log(p1__39780_SHARP_);
});
;})(pred__39783,expr__39784))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code__$1,p__39787){
...
var opts = map__39788__$1;
var eval_fn = cljs.core.get.call(null,map__39788__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
if(cljs.core.truth_(eval_fn)){
return eval_fn.call(null,code__$1,opts);
} else {
return eval(code);
}
});
...
return new_def.callback(p1__39790_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__39792,(0),null);
var v = cljs.core.nth.call(null,vec__39792,(1),null);
...
}catch (e39797){if((e39797 instanceof Error)){
var e = e39797;
return not_found;
} else {
throw e39797;
...
//# sourceMappingURL=utils.js.map?rel=1581732098876
