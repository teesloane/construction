...
return (new CustomEvent(event_name,(function (){var obj26181 = ({"detail":data});
return obj26181;
})()));
} else {
...
var f = (function (){var pred__26188 = cljs.core._EQ_;
var expr__26189 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__26188.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__26189))){
return ((function (pred__26188,expr__26189){
return (function (p1__26182_SHARP_){
return console.warn(p1__26182_SHARP_);
});
;})(pred__26188,expr__26189))
} else {
if(cljs.core.truth_(pred__26188.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__26189))){
return ((function (pred__26188,expr__26189){
return (function (p1__26183_SHARP_){
return console.debug(p1__26183_SHARP_);
});
;})(pred__26188,expr__26189))
} else {
if(cljs.core.truth_(pred__26188.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__26189))){
return ((function (pred__26188,expr__26189){
return (function (p1__26184_SHARP_){
return console.error(p1__26184_SHARP_);
});
;})(pred__26188,expr__26189))
} else {
return ((function (pred__26188,expr__26189){
return (function (p1__26185_SHARP_){
return console.log(p1__26185_SHARP_);
});
;})(pred__26188,expr__26189))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__26192){
...
var eval_fn = cljs.core.get.call(null,map__26193__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__26195_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__26197,(0),null);
...
}catch (e26202){if((e26202 instanceof Error)){
var e = e26202;
return not_found;
} else {
throw e26202;
...
//# sourceMappingURL=utils.js.map?rel=1581113873345
