...
return cljs.core.merge.call(null,initial_state,p1__35706_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_35707 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_35708 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_35707);
var pos_35709 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_35707);
quil.core.scale.call(null,zoom_35708);

var tr__26776__auto___35710 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_35708) - cljs.core.first.call(null,pos_35709)),(((quil.core.height.call(null) / (2)) / zoom_35708) - cljs.core.second.call(null,pos_35709))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__26776__auto___35710);
...
//# sourceMappingURL=navigation_2d.js.map?rel=1581732095261
