...
var vec__35655 = axis;
var a_x = cljs.core.nth.call(null,vec__35655,(0),null);
var a_y = cljs.core.nth.call(null,vec__35655,(1),null);
var a_z = cljs.core.nth.call(null,vec__35655,(2),null);
var vec__35658 = v;
var x = cljs.core.nth.call(null,vec__35658,(0),null);
var y = cljs.core.nth.call(null,vec__35658,(1),null);
var z = cljs.core.nth.call(null,vec__35658,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__35661,p__35662){
var vec__35663 = p__35661;
var u1 = cljs.core.nth.call(null,vec__35663,(0),null);
var u2 = cljs.core.nth.call(null,vec__35663,(1),null);
var u3 = cljs.core.nth.call(null,vec__35663,(2),null);
var vec__35666 = p__35662;
var v1 = cljs.core.nth.call(null,vec__35666,(0),null);
var v2 = cljs.core.nth.call(null,vec__35666,(1),null);
var v3 = cljs.core.nth.call(null,vec__35666,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__35669_SHARP_){
return (p1__35669_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__35670_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__35671_SHARP_,angle_lr),angle_ud);
...
var map__35673 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__35673__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__35673__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5733__auto__ = (function (){var pred__35675 = cljs.core._EQ_;
var expr__35676 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__35675.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__35676))){
return straight;
} else {
if(cljs.core.truth_(pred__35675.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__35676))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__35675.call(null,quil.middlewares.navigation_3d.space,expr__35676))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__35675.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__35676))){
return up;
} else {
if(cljs.core.truth_(pred__35675.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__35676))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__35675.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__35676))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5733__auto__,map__35673,map__35673__$1,up,straight){
return (function (p1__35672_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__35672_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5733__auto__,map__35673,map__35673__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__35678_SHARP_);
});})(initial_state))
);
});
/**
...
var map__35679_35690 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__35679_35691__$1 = (((((!((map__35679_35690 == null))))?(((((map__35679_35690.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__35679_35690.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__35679_35690):map__35679_35690);
var vec__35680_35692 = cljs.core.get.call(null,map__35679_35691__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_35693 = cljs.core.nth.call(null,vec__35680_35692,(0),null);
var c_y_35694 = cljs.core.nth.call(null,vec__35680_35692,(1),null);
var c_z_35695 = cljs.core.nth.call(null,vec__35680_35692,(2),null);
var vec__35683_35696 = cljs.core.get.call(null,map__35679_35691__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_35697 = cljs.core.nth.call(null,vec__35683_35696,(0),null);
var u_y_35698 = cljs.core.nth.call(null,vec__35683_35696,(1),null);
var u_z_35699 = cljs.core.nth.call(null,vec__35683_35696,(2),null);
var vec__35686_35700 = cljs.core.get.call(null,map__35679_35691__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_35701 = cljs.core.nth.call(null,vec__35686_35700,(0),null);
var p_y_35702 = cljs.core.nth.call(null,vec__35686_35700,(1),null);
var p_z_35703 = cljs.core.nth.call(null,vec__35686_35700,(2),null);
quil.core.camera.call(null,p_x_35701,p_y_35702,p_z_35703,(p_x_35701 + c_x_35693),(p_y_35702 + c_y_35694),(p_z_35703 + c_z_35695),u_x_35697,u_y_35698,u_z_35699);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1581732095231
